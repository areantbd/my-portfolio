  ...
  return lang?.lang === "esp" ? (
    <>
      ...
      <div className="container py-5">
        ...
        <br />
        <p>
          Nací en Taboada, un pueblo de la provincia de Lugo, en Galicia, en
          junio de 1987 y allí viví hasta 2007.
        </p>
        <p>
          ...
          estado trabajando en desarrollo de vehículos eléctricos, es aquí en
          donde he empezado a tocar/ver programación.
        </p>
        <p>
        ...
        <p>
          ...
          Laboralmente, soy una persona responsable, me gusta aprender y al
          mismo tiempo disfruto enseñando lo que ya sé. Bueno trabajando en
          equipo, pero me defiendo bien también en solitario.
        </p>
      </div>
    </>
  ) : (
    <>
      ...
      <div className="container py-5">
        ...
        <br />
        <p>
          I was born in Taboada, a village in the province of Lugo, in Galicia,
          on June 1987 and I lived there until 2007.
        </p>
        <p>
          In 2005 I started a medium grade cycle in Vehicle Electromechanics, a
          profession that I have been doing since 2007, just when I finished my
          studies. That led me to live a few years in Ourense and others in
          Lugo, after that I moved to Vigo, where I've been living for a few
          years now. As a mechanic I have worked in different workshops,
          developing different roles, from quick service mechanic to workshop
          manager. The last 4 years I have been working in electric vehicle
          development, where I started to play/see programming.
        </p>
        <p>
          ...
          weeks, but at the same time very fun, in which I have learned a lot
          about code and about myself.
        </p>
        <p>
        ...
        <p>
          ...
          love diving, hiking, photography and seeing new places. <br />
